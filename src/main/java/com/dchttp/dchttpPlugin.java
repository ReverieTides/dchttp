...
public class dchttpPlugin extends Plugin
{
	...
	public String msg;
	@Provides
	private dchttpConfig provideConfig(ConfigManager configManager)
	{
		return configManager.getConfig(dchttpConfig.class);
	}
